...
const OnboardingPage = () => {
  ...
  return (
    <div
      className="h-[100dvh] overflow-y-auto bg-gray-700 bg-base-100 flex items-start justify-center p-4 "
      data-theme="dark"
    >
      <div className="bg-base-200 rounded-2xl md:rounded-3xl w-full max-w-3xl shadow-xl">
