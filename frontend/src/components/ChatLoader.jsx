...
const ChatLoader = () => {
  ...
  return (
    <div className='relative border hidden md:flex border-base-300 rounded-2xl shadow-xl bg-base-300 flex-1 flex flex-col overflow-hidden items-center justify-center select-none' data-theme={theme}>
